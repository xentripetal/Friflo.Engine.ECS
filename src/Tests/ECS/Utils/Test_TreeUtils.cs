...
");
    ...
    ""components"": {
        ...
        /// <summary>
        ///     Cover <see cref="TreeUtils.AddDataEntitiesToEntity" /> and <see cref="TreeUtils.ReplaceChildrenPids" />
        /// </summary>
        [Test]
        public static void Test_TreeUtils_AddDataEntitiesToEntity()
        {
            ...
            {
                var dataEntity10 = new DataEntity
                {
                    pid = 10,
                ...
                var dataEntity11 = new DataEntity
                {
                    pid = 11
                };
                var dataEntities = new[]
                {
                    dataEntity10, dataEntity11
                };
