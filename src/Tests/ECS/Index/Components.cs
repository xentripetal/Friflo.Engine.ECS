...
namespace Tests.ECS.Index
{
    ...
    public struct ComparableEnum : IComparable<ComparableEnum>
    {
        ...
        public static implicit operator ComparableEnum(MyEnum value) => new()
        {
            value = value
        };
    }
    ...
    [CodeCoverageTest]
    struct IndexedIntRange : IIndexedComponent<int>
    {
        internal int value;
        public int GetIndexedValue() => value;
    ...
    struct IndexedStringRange : IIndexedComponent<string>
    {
