...
namespace Tests.ECS.Index
{
    public static class Test_Index_Types
    {
        ...
        public static void Test_Index_Types_Guid()
        {
            ...
            entity1.AddComponent(new GuidComponent
            {
                guid = guid1
            });
            ...
            entity2.AddComponent(new GuidComponent
            {
                guid = guid2
            });
            AreEqual(1, query0.Count);
        ...
        public static void Test_Index_Types_DateTime()
        {
            ...
            entity1.AddComponent(new DateTimeComponent
            {
                dateTime = date1
            });
            AreEqual(1, query1.Count);
            ...
            entity2.AddComponent(new DateTimeComponent
            {
                dateTime = date2
            });
            AreEqual(1, query1.Count);
        ...
        public static void Test_Index_Types_enum()
        {
            ...
            entity1.AddComponent(new EnumComponent
            {
                value = MyEnum.E0
            });
            ...
            entity2.AddComponent(new EnumComponent
            {
                value = MyEnum.E1
            });
            AreEqual(1, query1.Count);
            ...
            entity3.AddComponent(new EnumComponent
            {
                value = MyEnum.E2
            });
            AreEqual(1, query1.Count);
        ...
        public static void Test_Index_Types_enum_comparable()
        {
            ...
            entity1.AddComponent(new ComparableEnumComponent
            {
                value = MyEnum.E0
            });
            AreEqual(0, query1.Count);
            ...
            entity2.AddComponent(new ComparableEnumComponent
            {
                value = MyEnum.E1
            });
            AreEqual(1, query1.Count);
            ...
            entity3.AddComponent(new ComparableEnumComponent
            {
                value = MyEnum.E2
            });
            AreEqual(1, query1.Count);
