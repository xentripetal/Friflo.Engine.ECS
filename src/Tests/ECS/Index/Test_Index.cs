    ...
    public static class Test_Index
    {
        ...
        public static void Test_Index_ValueInRange_ValueStructIndex()
        {
            ...
            for (var n = 1; n <= 10; n++)
            {
                ...
                entity.AddComponent(new IndexedInt
                {
                    value = n
                });
        ...
        public static void Test_Index_ValueInRange_ValueClassIndex()
        {
            ...
            {
                var entity = store.CreateEntity(n);
                entity.AddComponent(new IndexedName
                {
                    name = n.ToString()
                });
                AreEqual(n, values.Count);
        ...
        public static void Test_Index_Component_Update()
        {
            ...
            entity1.AddComponent(new IndexedName
            {
                name = "find-me1"
            });
            AreEqual("{ find-me1 }", nameValues.Debug());
            entity2.AddComponent(new IndexedInt
            {
                value = 123
            });
            AreEqual("{ 123 }", intValues.Debug());
            entity3.AddComponent(new IndexedName
            {
                name = "find-me1"
            });
            AreEqual("{ find-me1 }", nameValues.Debug());
            entity3.AddComponent(new IndexedInt
            {
                value = 123
            });
            AreEqual("{ 123 }", intValues.Debug());
            ...
            AreEqual("{ 1, 3 }", query1.Entities.Debug());
            AreEqual(1, query2.Entities.Count);
            AreEqual("{ 3 }", query2.Entities.Debug());
            AreEqual(2, query3.Entities.Count);
            AreEqual("{ 1, 3 }", query3.Entities.Debug());
            ...
            AreEqual(2, nameValues.Count);
            AreEqual(1, query1.Entities.Count);
            AreEqual("{ 3 }", query1.Entities.Debug());
            AreEqual(1, query2.Entities.Count);
            AreEqual("{ 3 }", query2.Entities.Debug());
            AreEqual(1, query3.Entities.Count);
            AreEqual("{ 3 }", query3.Entities.Debug());
            ...
            AreEqual("{ }", query2.Entities.Debug());
            AreEqual(1, query3.Entities.Count);
            AreEqual("{ 1 }", query3.Entities.Debug());
        }
        ...
        public static void Test_Index_indexed_Entity()
        {
            ...
            entity1.AddComponent(new LinkComponent
            {
                entity = target4
            });
            AreEqual(1, values.Count);
            entity2.AddComponent(new LinkComponent
            {
                entity = target5
            });
            AreEqual(2, values.Count);
            entity3.AddComponent(new LinkComponent
            {
                entity = target5
            });
            AreEqual(2, values.Count);
            ...
            foreach (var entity in values)
            {
                ...
                {
                    case 0:
                        AreEqual(4, entity.Id);
                        break;

                    case 1:
                        AreEqual(5, entity.Id);
                        break;
                }
            }
            AreEqual(2, count);
            ...
            var query2 = store.Query().HasValue<LinkComponent, Entity>(target4).HasValue<LinkComponent, Entity>(target5);
            ...
            entity3.RemoveComponent<LinkComponent>();
            AreEqual(2, values.Count);
        ...
        public static void Test_Index_support_null()
        {
            ...
            entity2.AddComponent(new IndexedName
            {
                name = null
            });
        ...
        public static void Test_Index_ValueStructIndex()
        {
            ...
            {
                value = 123
            }); // add same component value again
        ...
        private static void Index_add_indexed_int_component_Perf(int componentCount, bool log)
        {
            ...
            sb?.AppendLine("| ------------------:| ------------------:| ------------------:|");
            for (var duplicateCount = 1; duplicateCount <= 32 * 1024; duplicateCount *= 2)
            {
                var store = new EntityStore();
                ...
                {
                    createdEntities[n].AddComponent(new IndexedInt
                    {
                        value = value
                    });
        ...
        public static void Test_Index_Perf()
        {
            ...
            {
                entities[n].AddComponent(new IndexedInt
                {
                    value = n
                });
            }
        ...
        public static void Test_Index_Perf_Reference()
        {
            ...
            for (var n = 0; n < count; n++)
            {
                entities[n].AddComponent(new General.MyComponent
                {
                    value = n
                });
            }
