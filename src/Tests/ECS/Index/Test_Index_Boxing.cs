...
namespace Tests.ECS.Index
{
    ...
    public static class Test_Index_Boxing
    {
        ...
        {
            var indexedName = new IndexedInt
            {
                value = 123
            };
        ...
        internal static V GetIndexedComponentValue<T, V>(in T component) where T : struct, IIndexedComponent<V> => component.GetIndexedValue();
