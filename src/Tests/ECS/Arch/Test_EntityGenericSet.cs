...
namespace Tests.ECS.Arch
{
    public static class Test_EntityGenericSet
    {
        ...
        public static void Test_Entity_generic_Set()
        {
            ...
            Action<ComponentChanged> componentAdded = changed => {
                ...
                switch (componentAddedCount++)
                {
                    ...
                    case 10:
                        AreEqual(new Position(2, 2, 2), changed.Component<Position>());
                        AreEqual("entity: 5 - event > Update Component: [Position]", str);
                        break;

                    case 11:
                        AreEqual(new Scale3(2, 2, 2), changed.Component<Scale3>());
                        AreEqual("entity: 5 - event > Update Component: [Scale3]", str);
                        break;

                    case 12:
                        AreEqual(new EntityName("new"), changed.Component<EntityName>());
                        AreEqual("entity: 5 - event > Update Component: [EntityName]", str);
                        break;
                    ...
                    case 13:
                        ...
                        AreEqual("entity: 5 - event > Update Component: [MyComponent1]", str);
                        break;

                    case 14:
                        AreEqual(new MyComponent2
                        {
                            b = 2
                        }, changed.Component<MyComponent2>());
                        AreEqual("entity: 5 - event > Update Component: [MyComponent2]", str);
                        break;
                }
            };
            ...
            for (var n = 0; n < 2; n++)
            {
                ...
                entity4.Set(new Position(2, 2, 2), new Scale3(2, 2, 2), new EntityName("new"), new MyComponent1
                {
                    a = 2
                });
                entity5.Set(new Position(2, 2, 2), new Scale3(2, 2, 2), new EntityName("new"), new MyComponent1
                {
                    a = 2
                }, new MyComponent2
                {
        ...
        public static void Test_Entity_generic_Set_6_and_more()
        {
            ...
            for (var n = 0; n < 5; n++)
            {
                entities[n] = store.CreateEntity(new Position(), new Scale3(), new Rotation(), new MyComponent1(), new MyComponent2(), new MyComponent3(),
                    new MyComponent4(), new MyComponent5(), new MyComponent6(), new MyComponent7());
            }
            ...
            entities[0].Set(new Position(1, 1, 1), new Scale3(1, 1, 1), new Rotation(1, 1, 1, 1), new MyComponent1
            {
                a = 1
            }, new MyComponent2
            {
            ...
            entities[1].Set(new Position(1, 1, 1), new Scale3(1, 1, 1), new Rotation(1, 1, 1, 1), new MyComponent1
            {
                a = 1
            }, new MyComponent2
            {
            ...
            entities[2].Set(new Position(1, 1, 1), new Scale3(1, 1, 1), new Rotation(1, 1, 1, 1), new MyComponent1
            {
                a = 1
            }, new MyComponent2
            {
            ...
            entities[3].Set(new Position(1, 1, 1), new Scale3(1, 1, 1), new Rotation(1, 1, 1, 1), new MyComponent1
            {
                a = 1
            }, new MyComponent2
            {
            ...
            entities[4].Set(new Position(1, 1, 1), new Scale3(1, 1, 1), new Rotation(1, 1, 1, 1), new MyComponent1
            {
                a = 1
            }, new MyComponent2
            {
            ...
            for (var n = 0; n < 5; n++)
            {
                ...
                {
                    b = 1
                }, entity.GetComponent<MyComponent2>());
                AreEqual(new MyComponent3
                {
                    b = 1
                }, entity.GetComponent<MyComponent3>());

                if (n > 0)
                    AreEqual(new MyComponent4
                    {
                        b = 1
                    }, entity.GetComponent<MyComponent4>());
                if (n > 1)
                    AreEqual(new MyComponent5
                    {
                        b = 1
                    }, entity.GetComponent<MyComponent5>());
                if (n > 2)
                    AreEqual(new MyComponent6
                    {
                        b = 1
                    }, entity.GetComponent<MyComponent6>());
                if (n > 3)
                    AreEqual(new MyComponent7
                    {
                        b = 1
                    }, entity.GetComponent<MyComponent7>());
            }
        ...
        public static void Test_Entity_generic_Set_exception()
        {
            ...
            AreEqual("entity id: 1  [EntityName, Position] - missing: [Scale3, Rotation, MyComponent1, MyComponent2, MyComponent3, MyComponent4, MyComponent5]",
                e!.Message);

            e = Throws<MissingComponentException>(() => {
                entity.Set(new Position(), new Scale3(), new Rotation(), new MyComponent1(), new MyComponent2(), new MyComponent3(), new MyComponent4(),
                    new MyComponent5(), new MyComponent6());
            });
            AreEqual(
                "entity id: 1  [EntityName, Position] - missing: [Scale3, Rotation, MyComponent1, MyComponent2, MyComponent3, MyComponent4, MyComponent5, MyComponent6]",
                e!.Message);

            e = Throws<MissingComponentException>(() => {
                entity.Set(new Position(), new Scale3(), new Rotation(), new MyComponent1(), new MyComponent2(), new MyComponent3(), new MyComponent4(),
                    new MyComponent5(), new MyComponent6(), new MyComponent7());
            });
            AreEqual(
                "entity id: 1  [EntityName, Position] - missing: [Scale3, Rotation, MyComponent1, MyComponent2, MyComponent3, MyComponent4, MyComponent5, MyComponent6, MyComponent7]",
                e!.Message);
        ...
        {
            var count = 10; // 100_000_000 ~ #PC: 1231 ms
            var store = new EntityStore(PidType.UsePidAsId);
