...
namespace Tests.ECS.Arch
{
    ...
    {
        private static readonly bool LogMinParallel = false;
        ...
        public static void Test_QueryJob_Run()
        {
            ...
            foreach ((var component1, var entities) in query.Chunks) { }
        ...
        /// all TPL
        /// <see cref="Parallel" />
        /// methods allocate memory. SO they are out.
        [Test]
        ...
        public static void Test_QueryJob_EntityStore_JobRunner()
        {
            ...
            var job = query.ForEach((_, entities) => {
                ...
                {
                    case 0:
                        Assert.AreEqual("MainThread", threadName);
                        break;

                    case 1:
                        Assert.AreEqual("MyRunner - worker 1", threadName);
                        break;
