...
namespace Tests.ECS.Arch
{
    public static class Test_EntityGenericAdd
    {
        ...
        public static void Test_Entity_generic_Add()
        {
            ...
            Action<TagsChanged> tagsChanged = changed => {
                ...
                switch (tagsCount++)
                {
                    ...
                    case 1:
                        AreEqual("entity: 2 - event > Add Tags: [#TestTag]", str);
                        break;

                    case 2:
                        AreEqual("entity: 3 - event > Add Tags: [#TestTag]", str);
                        break;

                    case 3:
                        AreEqual("entity: 4 - event > Add Tags: [#TestTag]", str);
                        break;

                    case 4:
                        AreEqual("entity: 5 - event > Add Tags: [#TestTag]", str);
                        break;

                    case 5:
                        AreEqual("entity: 101 - event > Add Tags: [#TestTag]", str);
                        break;

                    case 6:
                        AreEqual("entity: 101 - event > Add Tags: [#TestTag2]", str);
                        break;

                    case 7:
                        AreEqual("entity: 101 - event > Add Tags: [#TestTag3]", str);
                        break;
                }
            };
            ...
            Action<ComponentChanged> componentAdded = changed => {
                ...
                switch (componentAddedCount++)
                {
                    ...
                    // --- entity 2
                    case 2:
                        AreEqual("entity: 2 - event > Add Component: [Position]", str);
                        break;

                    case 3:
                        AreEqual("entity: 2 - event > Add Component: [Scale3]", str);
                        break;

                    case 4:
                        AreEqual(new Position(1, 1, 1), changed.OldComponent<Position>());
                        AreEqual(new Position(2, 2, 2), changed.Component<Position>());
                        AreEqual("entity: 2 - event > Update Component: [Position]", str);
                        break;

                    case 5:
                        AreEqual(new Scale3(1, 1, 1), changed.OldComponent<Scale3>());
                        AreEqual(new Scale3(2, 2, 2), changed.Component<Scale3>());
                        AreEqual("entity: 2 - event > Update Component: [Scale3]", str);
                        break;

                    // --- entity 3
                    case 6:
                        AreEqual("entity: 3 - event > Add Component: [Position]", str);
                        break;

                    case 7:
                        AreEqual("entity: 3 - event > Add Component: [Scale3]", str);
                        break;

                    case 8:
                        AreEqual("entity: 3 - event > Add Component: [EntityName]", str);
                        break;

                    case 9:
                        AreEqual(new Position(1, 1, 1), changed.OldComponent<Position>());
                        AreEqual(new Position(2, 2, 2), changed.Component<Position>());
                        AreEqual("entity: 3 - event > Update Component: [Position]", str);
                        break;

                    case 10:
                        AreEqual(new Scale3(1, 1, 1), changed.OldComponent<Scale3>());
                        AreEqual(new Scale3(2, 2, 2), changed.Component<Scale3>());
                        AreEqual("entity: 3 - event > Update Component: [Scale3]", str);
                        break;

                    case 11:
                        AreEqual(new EntityName("old"), changed.OldComponent<EntityName>());
                        AreEqual(new EntityName("new"), changed.Component<EntityName>());
                        AreEqual("entity: 3 - event > Update Component: [EntityName]", str);
                        break;

                    // --- entity 4
                    case 12:
                        AreEqual("entity: 4 - event > Add Component: [Position]", str);
                        break;

                    case 13:
                        AreEqual("entity: 4 - event > Add Component: [Scale3]", str);
                        break;

                    case 14:
                        AreEqual("entity: 4 - event > Add Component: [EntityName]", str);
                        break;

                    case 15:
                        AreEqual("entity: 4 - event > Add Component: [MyComponent1]", str);
                        break;

                    case 16:
                        AreEqual(new Position(1, 1, 1), changed.OldComponent<Position>());
                        AreEqual(new Position(2, 2, 2), changed.Component<Position>());
                        AreEqual("entity: 4 - event > Update Component: [Position]", str);
                        break;

                    case 17:
                        AreEqual(new Scale3(1, 1, 1), changed.OldComponent<Scale3>());
                        AreEqual(new Scale3(2, 2, 2), changed.Component<Scale3>());
                        AreEqual("entity: 4 - event > Update Component: [Scale3]", str);
                        break;

                    case 18:
                        AreEqual(new EntityName("old"), changed.OldComponent<EntityName>());
                        AreEqual(new EntityName("new"), changed.Component<EntityName>());
                        AreEqual("entity: 4 - event > Update Component: [EntityName]", str);
                        break;

                    case 19:
                        AreEqual(new MyComponent1
                        {
                            a = 1
                        }, changed.OldComponent<MyComponent1>());
                        AreEqual(new MyComponent1
                        {
                            a = 2
                        }, changed.Component<MyComponent1>());
                        AreEqual("entity: 4 - event > Update Component: [MyComponent1]", str);
                        break;

                    // --- entity 101
                    case 30:
                        AreEqual("entity: 101 - event > Add Component: [Position]", str);
                        break;

                    case 31:
                        AreEqual(new Position(1, 1, 1), changed.OldComponent<Position>());
                        AreEqual(new Position(2, 2, 2), changed.Component<Position>());
                        AreEqual("entity: 101 - event > Update Component: [Position]", str);
                        break;

                    case 32:
                        AreEqual("entity: 101 - event > Add Component: [Scale3]", str);
                        break;
            ...
            for (var n = 0; n < 2; n++)
            {
                ...
                entity4.Add(new Position(1, 1, 1), new Scale3(1, 1, 1), new EntityName("old"), new MyComponent1
                {
                    a = 1
                }, tag);
                entity4.Add(new Position(2, 2, 2), new Scale3(2, 2, 2), new EntityName("new"), new MyComponent1
                {
                    a = 2
                }, tag);
                AreEqual("id: 4  \"new\"  [EntityName, Position, Scale3, MyComponent1, #TestTag]", entity4.ToString());

                entity5.Add(new Position(1, 1, 1), new Scale3(1, 1, 1), new EntityName("old"), new MyComponent1
                {
                    a = 1
                }, new MyComponent2
                {
                ...
                entity5.Add(new Position(2, 2, 2), new Scale3(2, 2, 2), new EntityName("new"), new MyComponent1
                {
                    a = 2
                }, new MyComponent2
                {
        ...
        public static void Test_Entity_generic_Add_6_and_more()
        {
            ...
            entities[2].Add(new Position(), new Scale3(), new Rotation(), new MyComponent1(), new MyComponent2(), new MyComponent3(), new MyComponent4(),
                new MyComponent5(), tag);
            entities[3].Add(new Position(), new Scale3(), new Rotation(), new MyComponent1(), new MyComponent2(), new MyComponent3(), new MyComponent4(),
                new MyComponent5(), new MyComponent6(), tag);
            entities[4].Add(new Position(), new Scale3(), new Rotation(), new MyComponent1(), new MyComponent2(), new MyComponent3(), new MyComponent4(),
                new MyComponent5(), new MyComponent6(), new MyComponent7(), tag);
            ...
            AreEqual("id: 3  [Position, Rotation, Scale3, MyComponent1, MyComponent2, MyComponent3, MyComponent4, MyComponent5, #TestTag]",
                entities[2].ToString());
            AreEqual("id: 4  [Position, Rotation, Scale3, MyComponent1, MyComponent2, MyComponent3, MyComponent4, MyComponent5, MyComponent6, #TestTag]",
                entities[3].ToString());
            AreEqual(
                "id: 5  [Position, Rotation, Scale3, MyComponent1, MyComponent2, MyComponent3, MyComponent4, MyComponent5, MyComponent6, MyComponent7, #TestTag]",
                entities[4].ToString());
        ...
        {
            var count = 10; // 100_000_000 ~ #PC: 2828 ms
            var store = new EntityStore(PidType.UsePidAsId);
        ...
        {
            var count = 10; // 100_000_000 ~ #PC: 9827 ms
            var store = new EntityStore(PidType.UsePidAsId);
            var entity = store.CreateEntity();
