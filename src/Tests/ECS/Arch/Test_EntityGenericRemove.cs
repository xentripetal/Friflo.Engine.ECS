    ...
    public static class Test_EntityGenericRemove
    {
        ...
        public static void Test_Entity_generic_Remove()
        {
            ...
            Action<TagsChanged> tagsChanged = changed => {
                ...
                {
                    case 0:
                        AreEqual("entity: 1 - event > Remove Tags: [#TestTag]", str);
                        break;

                    case 1:
                        AreEqual("entity: 2 - event > Remove Tags: [#TestTag]", str);
                        break;

                    case 2:
                        AreEqual("entity: 3 - event > Remove Tags: [#TestTag]", str);
                        break;

                    case 3:
                        AreEqual("entity: 4 - event > Remove Tags: [#TestTag]", str);
                        break;

                    case 4:
                        AreEqual("entity: 5 - event > Remove Tags: [#TestTag]", str);
                        break;

                    case 5:
                        AreEqual("entity: 102 - event > Remove Tags: [#TestTag]", str);
                        break;

                    case 6:
                        AreEqual("entity: 102 - event > Remove Tags: [#TestTag2]", str);
                        break;

                    case 7:
                        AreEqual("entity: 102 - event > Add Tags: [#TestTag2]", str);
                        break;
                }
            };
            var componentRemovedCount = 0;
            Action<ComponentChanged> componentRemoved = changed => {
                ...
                switch (componentRemovedCount++)
                {
                    ...
                    case 0:
                        ...
                        AreEqual("entity: 1 - event > Remove Component: [Position]", str);
                        break;

                    // --- entity 2
                    case 1:
                        AreEqual(new Position(1, 1, 1), changed.OldComponent<Position>());
                        AreEqual("entity: 2 - event > Remove Component: [Position]", str);
                        break;

                    case 2:
                        AreEqual(new Scale3(1, 1, 1), changed.OldComponent<Scale3>());
                        AreEqual("entity: 2 - event > Remove Component: [Scale3]", str);
                        break;

                    // --- entity 3
                    case 3:
                        AreEqual(new Position(1, 1, 1), changed.OldComponent<Position>());
                        AreEqual("entity: 3 - event > Remove Component: [Position]", str);
                        break;

                    case 4:
                        AreEqual(new Scale3(1, 1, 1), changed.OldComponent<Scale3>());
                        AreEqual("entity: 3 - event > Remove Component: [Scale3]", str);
                        break;

                    case 5:
                        AreEqual(new EntityName("old"), changed.OldComponent<EntityName>());
                        AreEqual("entity: 3 - event > Remove Component: [EntityName]", str);
                        break;

                    // --- entity 4
                    case 6:
                        AreEqual(new Position(1, 1, 1), changed.OldComponent<Position>());
                        AreEqual("entity: 4 - event > Remove Component: [Position]", str);
                        break;

                    case 7:
                        AreEqual(new Scale3(1, 1, 1), changed.OldComponent<Scale3>());
                        AreEqual("entity: 4 - event > Remove Component: [Scale3]", str);
                        break;

                    case 8:
                        AreEqual(new EntityName("old"), changed.OldComponent<EntityName>());
                        AreEqual("entity: 4 - event > Remove Component: [EntityName]", str);
                        break;
                    ...
                    case 9:
                        ...
                        AreEqual("entity: 4 - event > Remove Component: [MyComponent1]", str);
                        break;

                    // --- entity 5
                    case 10:
                        AreEqual(new Position(1, 1, 1), changed.OldComponent<Position>());
                        AreEqual("entity: 5 - event > Remove Component: [Position]", str);
                        break;

                    case 11:
                        AreEqual(new Scale3(1, 1, 1), changed.OldComponent<Scale3>());
                        AreEqual("entity: 5 - event > Remove Component: [Scale3]", str);
                        break;

                    case 12:
                        AreEqual(new EntityName("old"), changed.OldComponent<EntityName>());
                        AreEqual("entity: 5 - event > Remove Component: [EntityName]", str);
                        break;
                    ...
                    case 13:
                        ...
                        AreEqual("entity: 5 - event > Remove Component: [MyComponent1]", str);
                        break;
                    ...
                    case 14:
                        ...
                        {
                            b = 1
                        }, changed.OldComponent<MyComponent2>());
                        AreEqual("entity: 5 - event > Remove Component: [MyComponent2]", str);
                        break;

                    // --- entity 102
                    case 15:
                        AreEqual("entity: 102 - event > Remove Component: [Scale3]", str);
                        break;
        ...
        public static void Test_Entity_generic_Remove_6_and_more()
        {
            ...
            for (var n = 0; n < 5; n++)
            {
                entities[n] = store.CreateEntity(new Position(), new Scale3(), new Rotation(), new MyComponent1(), new MyComponent2(), new MyComponent3(),
                    new MyComponent4(), new MyComponent5(), new MyComponent6(), new MyComponent7(), tag);
            }
            var tagEventCount = 0;
            ...
            entities[4]
                .Remove<Position, Scale3, Rotation, MyComponent1, MyComponent2, MyComponent3, MyComponent4, MyComponent5, MyComponent6, MyComponent7>(tag);
        ...
        {
            var count = 10; // 100_000_000 ~ #PC: 2017 ms
            var store = new EntityStore(PidType.UsePidAsId);
