...
namespace Tests.ECS.Serialize
{
    public static class Test_EntityConverter
    {
        ...
        public static void Test_EntityConverter_Load_single_entity()
        {
            ...
            var entity2 = converter.DataEntityToEntity(new DataEntity
            {
                pid = 2
            }, store, out _);
        ...
        public static void Test_EntityConverter_Load_parent_child()
        {
            ...
            var entity5 = converter.DataEntityToEntity(CreateDataEntity(5, new[]
            {
                8
            }), store, out _);
            ...
            // --- create child 8
            entity8 = converter.DataEntityToEntity(new DataEntity
            {
                pid = 8
            }, store, out _);
        ...
        public static void Test_EntityConverter_Load_child_parent()
        {
            ...
            var entity8 = converter.DataEntityToEntity(new DataEntity
            {
                pid = 8
            }, store, out _);
            IsTrue(entity8 == store.GetEntityById(8));
        ...
        public static void Test_EntityConverter_Load_error_multiple_parents_1()
        {
            ...
            converter.DataEntityToEntity(CreateDataEntity(1, new[]
            {
                2, 3
            }), store, out _);

            var e = Throws<InvalidOperationException>(() => {
                _ = converter.DataEntityToEntity(CreateDataEntity(2, new[]
                {
                    3
                }), store, out _);
            });
        ...
        public static void Test_EntityConverter_Load_error_multiple_parents_2()
        {
            ...
            var e = Throws<InvalidOperationException>(() => {
                converter.DataEntityToEntity(CreateDataEntity(3, new[]
                {
                    2
                }), store, out _);
            });
        ...
        public static void Test_EntityConverter_Load_error_cycle_2()
        {
            ...
            var e = Throws<InvalidOperationException>(() => {
                converter.DataEntityToEntity(CreateDataEntity(2, new[]
                {
                    1
                }), store, out _);
            });
        ...
        public static void Test_EntityConverter_Load_Perf()
        {
            ...
            var count = 10; // 10_000_000 ~ #PC: 2.199 ms
            var entity = new DataEntity();
