...
namespace Tests.ECS.Base
{
    public static class Test_Components
    {
        ...
        public static void Test_Generic_Component()
        {
            ...
            entity.AddComponent(new GenericComponent<int>
            {
                value = 37
            });
            AreEqual(37, entity.GetComponent<GenericComponent<int>>().value);

            entity.AddComponent(new GenericComponent3<int, int, int>
            {
                value1 = 1,
                value2 = 2,
                value3 = 3
            });
            var expect = new GenericComponent3<int, int, int>
            {
                value1 = 1,
                value2 = 2,
                value3 = 3
        ...
        public static void Test_Generic_Component_exceptions()
        {
            ...
            AreEqual("Missing attribute [GenericInstanceType(\"<key>\", typeof(Int64))] for generic IComponent type: Tests.ECS.GenericComponent`1[System.Int64]",
                inner!.Message);
            ...
            AreEqual(
                "Missing attribute [GenericInstanceType(\"<key>\", typeof(Int32), typeof(String))] for generic ITag type: Tests.ECS.GenericTag2`2[System.Int32,System.String]",
                inner!.Message);
        }
