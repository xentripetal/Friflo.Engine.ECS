...
namespace Tests.ECS.Relations
{
    public static class Test_Relations
    {
        ...
        public static void Test_Relations_enum_relation()
        {
            ...
            entity.AddRelation(new InventoryItem
            {
                type = InventoryItemType.Axe,
                amount = 1
            });
            entity.AddRelation(new InventoryItem
            {
        ...
        public static void Test_Relations_add_remove()
        {
            ...
            IsTrue(entity3.AddRelation(new AttackRelation
            {
                target = target10,
                speed = 1
            }));
            ...
            IsFalse(entity3.AddRelation(new AttackRelation
            {
                target = target11,
                speed = 42
            }));
...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        public static void Test_Relations_int_relation()
        {
            ...
            foreach (var entity in entities)
            {
                for (var n = 0; n < relationCount; n++)
                {
                    ...
                    Mem.IsTrue(entity.AddRelation(new IntRelation
                    {
                        value = n
                    }));
                }
        ...
        public static void Test_Relations_null_relation_key()
        {
            var store = new EntityStore();
            var entity = store.CreateEntity();
            entity.AddRelation(new StringRelation
            {
                value = null
            });
