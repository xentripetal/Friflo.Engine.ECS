...
namespace Tests.ECS.Systems
{
    ...
    public class MySystem_Arg1 : QuerySystem<Position>
    {
        ...
        protected override void OnUpdate()
        {
            ...
            var chunkCount = 0;
            foreach ((var position, var entities) in Query.Chunks)
            {
                ...
                {
                    case 0:
                        Mem.AreEqual(1, length);
                        Mem.AreSame(store.StoreRoot.Archetype, entities.Archetype);
                        break;

                    case 1:
                        Mem.AreEqual(999, length);
                        Mem.AreSame(childArch, entities.Archetype);
                        break;
    ...
    public class MySystem_Arg2 : QuerySystem<Position, Rotation>
    {
        ...
        protected override void OnUpdate()
        {
            ...
            var chunkCount = 0;
            foreach ((var positions, var rotations, var entities) in Query.Chunks)
            {
    ...
    public class MySystem_Arg3 : QuerySystem<Position, Rotation, EntityName>
    {
        ...
        protected override void OnUpdate()
        {
            ...
            var chunkCount = 0;
            foreach ((var positions, var rotation, var name, var entities) in Query.Chunks)
            {
                var length = entities.Length;
                Mem.AreEqual(length, positions.Length);
    ...
    public class MySystem_Arg4 : QuerySystem<Position, Rotation, EntityName, Scale3>
    {
        ...
        protected override void OnUpdate()
        {
            ...
            var chunkCount = 0;
            foreach ((var positions, var rotation, var name, var scale, var entities) in Query.Chunks)
            {
    ...
    public class MySystem_Arg5 : QuerySystem<Position, Rotation, EntityName, Scale3, Transform>
    {
        ...
        protected override void OnUpdate()
        {
            ...
            var chunkCount = 0;
            foreach ((var positions, var rotation, var name, var scale, var transform, var entities) in Query.Chunks)
            {
    ...
    public static class Test_ScriptSystems
    {
        ...
        public static void Test_ScriptSystems_query_arg_count_0()
        {
            ...
            CreateSystems(store);
            var count = 10; // 10_000_000 ~ #PC: 1575 ms
        ...
        public static void Test_ScriptSystems_query_arg_count_2()
        {
            ...
            CreateSystems(store);
            var count = 10; // 10_000_000 ~ #PC: 1387 ms
            ExecuteSystems(store, count);
        }
        ...
        public static void Test_ScriptSystems_query_arg_count_3()
        {
            ...
            CreateSystems(store);
            var count = 10; // 10_000_000 ~ #PC: 1500 ms
            ExecuteSystems(store, count);
        }
        ...
        public static void Test_ScriptSystems_query_arg_count_4()
        {
            ...
            CreateSystems(store);
            var count = 10; // 10_000_000 ~ #PC: 1757 ms
            ExecuteSystems(store, count);
        }
        ...
        public static void Test_ScriptSystems_query_arg_count_5()
        {
            ...
            CreateSystems(store);
            var count = 10; // 10_000_000 ~ #PC: 1847 ms
            ExecuteSystems(store, count);
        }
