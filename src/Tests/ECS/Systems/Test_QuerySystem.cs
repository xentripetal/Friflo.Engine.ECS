...
namespace Tests.ECS.Systems
{
    ...
    class TestQuerySystem0 : QuerySystem
    {
        protected override void OnUpdate() { }
    }

    class TestQuerySystem1 : QuerySystem<Position>
    {
        protected override void OnUpdate() { }
    }

    class TestQuerySystem2 : QuerySystem<Position, Scale3>
    {
        protected override void OnUpdate() { }
    }

    class TestQuerySystem3 : QuerySystem<Position, Scale3, Rotation>
    {
        protected override void OnUpdate() { }
    }

    class TestQuerySystem4 : QuerySystem<Position, Scale3, Rotation, MyComponent5>
    {
        protected override void OnUpdate() { }
    }

    class TestQuerySystem5 : QuerySystem<Position, Scale3, Rotation, MyComponent5, MyComponent6>
    {
        protected override void OnUpdate() { }
    }
}
