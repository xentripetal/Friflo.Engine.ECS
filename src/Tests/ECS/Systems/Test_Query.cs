...
namespace Tests.ECS.Systems
{
    public static class Test_Query
    {
        ...
        public static void Test_Query_arg_count_1()
        {
            ...
            foreach (var chunk in query.Chunks)
            {
                if (chunkCount++ == 1)
                {
                    ...
                    Mem.AreEqual("Chunks[1]    Archetype: [EntityName, Position, Rotation, Scale3, Transform, TreeNode, MyComponent1]  entities: 1",
                        chunk.ToString());
        ...
        public static void Test_Query_arg_count_3()
        {
            ...
            for (long n = 0; n < Count; n++)
            {
                foreach ((_, _, _, _) in query.Chunks) { }
            }
            Mem.AssertNoAlloc(start);
        }
        ...
        public static void Test_Query_arg_count_4()
        {
            ...
            for (long n = 0; n < Count; n++)
            {
                foreach ((_, _, _, _, _) in query.Chunks) { }
            }
            Mem.AssertNoAlloc(start);
        }
        ...
        public static void Test_Query_arg_count_5()
        {
            ...
            for (long n = 0; n < Count; n++)
            {
                foreach ((_, _, _, _, _, _) in query.Chunks) { }
            }
            Mem.AssertNoAlloc(start);
        }
        ...
        public static void Test_Query_Chunk_StepVector()
        {
            ...
            foreach ((var byteComponent, var intComponent, _) in query.Chunks)
            {
        ...
        public static void Test_Query_Chunk_Padding()
        {
            ...
            for (var n = 0; n < 200; n++)
            {
                foreach ((var components, _) in query.Chunks)
                {
                    ...
                    {
                        case 0:
                            Mem.AreEqual(0, span128.Length);
                            break;

                        case > 0 and <= 16:
                            Mem.AreEqual(16, span128.Length);
                            break;

                        case > 16 and <= 32:
                            Mem.AreEqual(32, span128.Length);
                            break;

                        case > 32 and <= 48:
                            Mem.AreEqual(48, span128.Length);
                            break;

                        case > 48 and <= 64:
                            Mem.AreEqual(64, span128.Length);
                            break;
                    }
                    ...
                    {
                        case 0:
                            Mem.AreEqual(0, span256.Length);
                            break;

                        case > 0 and <= 32:
                            Mem.AreEqual(32, span256.Length);
                            break;

                        case > 32 and <= 64:
                            Mem.AreEqual(64, span256.Length);
                            break;

                        case > 64 and <= 96:
                            Mem.AreEqual(96, span256.Length);
                            break;

                        case > 96 and <= 128:
                            Mem.AreEqual(128, span256.Length);
                            break;
                    }
                    ...
                    {
                        case 0:
                            Mem.AreEqual(0, span512.Length);
                            break;

                        case > 0 and <= 64:
                            Mem.AreEqual(64, span512.Length);
                            break;

                        case > 64 and <= 128:
                            Mem.AreEqual(128, span512.Length);
                            break;

                        case > 128 and <= 192:
                            Mem.AreEqual(192, span512.Length);
                            break;

                        case > 192:
                            Mem.AreEqual(256, span512.Length);
                            break;
                    }
                }
