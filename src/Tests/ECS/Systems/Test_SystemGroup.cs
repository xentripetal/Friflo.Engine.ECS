    ...
    public static class Test_SystemGroup
    {
        ...
        public static void Test_SystemGroup_MoveTo()
        {
            ...
            Action<SystemChanged> rootChanged = changed => {
                ...
                {
                    case 0:
                        AreEqual("Add - Group 'Group1' to 'Systems'", str);
                        return;

                    case 1:
                        AreEqual("Add - Group 'Group2' to 'Systems'", str);
                        return;

                    case 2:
                        AreEqual("Add - Group 'Group3' to 'Systems'", str);
                        return;

                    case 3:
                        AreEqual("Move - Group 'Group1' from 'Systems' to 'Group3'", str);
                        return;

                    case 4:
                        AreEqual("Move - Group 'Group2' from 'Systems' to 'Group3'", str);
                        return;

                    case 5:
                        AreEqual("Move - Group 'Group1' from 'Group3' to 'Group3'", str);
                        return;

                    case 6:
                        AreEqual("Move - Group 'Group2' from 'Group3' to 'Group3'", str);
                        return;
                }
            };
        ...
        public static void Test_SystemGroup_RemoveSystem_with_root()
        {
            ...
            Action<SystemChanged> rootChanged = changed => {
                ...
                {
                    case 0:
                        AreEqual("Add - System 'TestSystem1' to 'Systems'", str);
                        return;

                    case 1:
                        AreEqual("Remove - System 'TestSystem1' from 'Systems'", str);
                        return;
                }
            };
            Action<SystemChanged> groupChanged = changed => {
                ...
                {
                    case 0:
                        AreEqual("Add - System 'TestSystem2' to 'Update'", str);
                        return;

                    case 1:
                        AreEqual("Remove - System 'TestSystem2' from 'Update'", str);
                        return;
                }
            };
            root.OnSystemChanged += rootChanged;
        ...
        public static void Test_SystemGroup_RemoveSystem_without_root()
        {
            ...
            baseGroup.OnSystemChanged += changed => {
                ...
                {
                    case 0:
                        AreEqual("Add - System 'TestSystem1' to 'Base'", str);
                        return;

                    case 1:
                        AreEqual("Remove - System 'TestSystem1' from 'Base'", str);
                        return;
                }
            };
        ...
        public static void Test_SystemGroup_CastSystemChanged()
        {
            ...
            Action<SystemChanged> testChanged = changed => {
                ...
                {
                    case 0:
                        AreEqual("Update - System 'TestSystem1' field: enabled, value: True", str);
                        return;
                }
            };
            Action<SystemChanged> rootChanged = changed => {
...
", emptyLog);
            ...
            root.Update(default);
            IsTrue(root.Perf.LastMs == -1);
            AreEqual(0, root.Perf.UpdateCount);
            IsTrue(child1.Perf.LastMs == -1);
            AreEqual(0, child1.Perf.UpdateCount);
            IsTrue(perfSystem1.Perf.LastMs == -1);
            AreEqual(0, perfSystem1.Perf.UpdateCount);
            IsTrue(perfSystem2.Perf.LastMs == -1);
            AreEqual(0, perfSystem2.Perf.UpdateCount);
            ...
            root.Update(default);
            IsTrue(root.Perf.LastMs > 0);
            AreEqual(1, root.Perf.UpdateCount);
            IsTrue(child1.Perf.LastMs > 0);
            AreEqual(1, child1.Perf.UpdateCount);
            IsTrue(perfSystem1.Perf.LastMs > 0);
            AreEqual(1, perfSystem1.Perf.UpdateCount);
            IsTrue(perfSystem2.Perf.LastMs > 0);
            AreEqual(1, perfSystem2.Perf.UpdateCount);
            ...
            root.Update(default);
            IsTrue(root.Perf.LastMs > 0);
            AreEqual(3, root.Perf.UpdateCount);
            IsTrue(child1.Perf.LastMs > 0);
            AreEqual(3, child1.Perf.UpdateCount);
            IsTrue(perfSystem1.Perf.LastMs == -1);
            AreEqual(2, perfSystem1.Perf.UpdateCount);
            IsTrue(perfSystem2.Perf.LastMs > 0);
            AreEqual(3, perfSystem2.Perf.UpdateCount);

            child1.Enabled = false;
            root.Update(default);
            IsTrue(root.Perf.LastMs > 0);
            AreEqual(4, root.Perf.UpdateCount);
            IsTrue(child1.Perf.LastMs == -1);
            AreEqual(3, child1.Perf.UpdateCount);
            IsTrue(perfSystem1.Perf.LastMs == -1);
            AreEqual(2, perfSystem1.Perf.UpdateCount);
