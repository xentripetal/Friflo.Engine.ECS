...
// See: https://friflo.gitbook.io/friflo.engine.ecs/examples/optimization
    public static class Optimization
    {
        ...
        public static void EnumerateQueryChunks()
        {
            ...
            foreach ((var components, var entities) in query.Chunks)
            {
        ...
        public static void QueryVectorization()
        {
            ...
            var query = store.Query<MyComponent>();
            foreach ((var component, var entities) in query.Chunks)
            {
                ...
                for (var n = 0; n < values.Length; n += step)
                {
        ...
        public static void FilterEntityEvents()
        {
            ...
            {
                var hasEvent = query.HasEvent(entity.Id);
        ...
        /// Obsolete! Prefer using significant more performant
        /// <c>CreateEntity()</c>
        /// overloads used
        /// in
        /// <see cref="CreateEntityOperation" />
        /// above.
        [Test]
        ...
        /// An EntityBatch should only be used when adding
        /// <b>AND</b>
        /// removing components / tags to the same entity.
        /// <br />
        /// If only adding
        /// <b>OR</b>
        /// removing components / tags use the
        /// <c>Add() / Remove()</c>
        /// overloads shown above.
        [Test]
