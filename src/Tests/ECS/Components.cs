...
// two classes with indirect type cycle
    class CycleClass1
    {
        internal CycleClass2 cycle2;
    }

    class CycleClass2
    {
        internal CycleClass1 cycle1;
    }

    [ComponentKey("my2")]
    [ComponentSymbol("M2 too long")]
    public struct MyComponent2 : IComponent
    {
        public int b;
    }
    ...
    public struct MyComponent3 : IComponent
    {
        public int b;
    }
    ...
    public struct MyComponent4 : IComponent
    {
        public int b;
    }

    [ComponentKey("my5")]
    public struct MyComponent5 : IComponent
    {
        public int b;
    }

    [ComponentKey("my6")]
    public struct MyComponent6 : IComponent
    {
        public int b;
    }

    [ComponentKey("my7")]
    public struct MyComponent7 : IComponent
    {
        public int b;
    }

    public struct NonBlittableArray : IComponent
    {
        internal int[] array;
    }

    public struct NonBlittableList : IComponent
    {
        internal List<int> list;
    }

    public struct NonBlittableDictionary : IComponent
    {
        internal Dictionary<int, int> map;
    }

    public struct NonBlittableCycle : IComponent
    {
        internal CycleClass cycle;
    }

    public struct NonBlittableCycle2 : IComponent
    {
        internal CycleClass1 cycle1;
    }

    public struct BlittableDatetime : IComponent
    {
        public DateTime dateTime;
    }

    public struct BlittableGuid : IComponent
    {
        public Guid guid;
    }

    public struct BlittableBigInteger : IComponent
    {
        public BigInteger bigInteger;
    }

    public struct BlittableUri : IComponent
    {
        public Uri uri;
    } // throws exception when serialized

    [ComponentKey(null)]
    public struct NonSerializedComponent : IComponent
    {
        public int value;
    }
    ...
    [CodeCoverageTest]
    [ComponentKey("byte")]
    public struct ByteComponent : IComponent
    {
        public byte b;
    }

    public struct ShortComponent : IComponent
    {
        public short b;
    }
    ...
    public struct LongComponent : IComponent
    {
        public long b;
    }
...
// test missing [StructComponent()] attribute
    struct MyInvalidComponent : IComponent
    {
        public int b;
    }
...
// ------------------------------------------------ scripts
    ...
    /// <summary>
    ///     Used only to cover <see cref="SchemaTypeUtils.GetStructIndex" />
    ///     Deprecated methods
    ///     TagType.NewTagIndex()
...
namespace Tests.Duplicates
{
    ...
    [ComponentKey("my7")]
    struct DupMyComponent7 : IComponent { }

    // Cover: warning: Duplicate component key  for a script
    [ComponentKey("script4")]
    class DupScript4 : Script { }
