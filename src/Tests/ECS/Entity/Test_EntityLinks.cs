...
namespace Tests.ECS
{
    public static class Test_EntityLinks
    {
        ...
        public static void Test_EntityLinks_AllIncomingLinks()
        {
            ...
            entity2.AddComponent(new AttackComponent
            {
                target = entity1,
                data = 2
            });
            ...
            entity3.AddComponent(new AttackComponent
            {
                target = entity1,
                data = 4
            });
        ...
        public static void Test_EntityLinks_IncomingLinkComponent()
        {
            ...
            foreach (var reference in refs5)
            {
                ...
                {
                    case 0:
                        AreEqual(101, reference.Component.data);
                        break;

                    case 1:
                        AreEqual(102, reference.Component.data);
                        break;
                }
            }
            AreEqual(2, count);
