...
namespace Tests.ECS
{
    public static class Test_Entity
    {
        ...
        public static void Assert_TryGetEntityById()
        {
            ...
            IsFalse(store.TryGetEntityById(-1, out var entity));
            IsTrue(entity.IsNull);
...
#pragma warning restore CS1718
        ...
        public static void Test_Entity_create_delete_Entity_events()
        {
            ...
            Action<EntityCreate> createHandler = create => {
                ...
                {
                    case 0:
                        AreSame(store, create.Store);
                        AreEqual("id: 1  []", create.Entity.ToString());
                        AreEqual("entity: 1 - event > EntityCreate", str);
                        break;

                    case 1:
                        AreEqual("entity: 10 - event > EntityCreate", str);
                        break;

                    case 2:
                        AreEqual("entity: 2 - event > EntityCreate", str);
                        break;

                    case 3:
                        AreEqual("entity: 11 - event > EntityCreate", str);
                        break;

                    case 4:
                        AreEqual("entity: 3 - event > EntityCreate", str);
                        break;
        ...
        {
            var count = 10; // 10_000_000 ~ #PC: 316 ms
            var store = new EntityStore(PidType.UsePidAsId);
        ...
        {
            var count = 10; // 10_000_000 ~ #PC: 309 ms
            var store = new EntityStore(PidType.UsePidAsId);
            store.EnsureCapacity(count);
        ...
        public static void Test_Entity_CreateEntity_generic()
        {
            ...
            store.OnEntityCreate += create => {
                ...
                {
                    case 0:
                        AreEqual("id: 1  [#TestTag]", str);
                        break;

                    case 1:
                        AreEqual("id: 2  [Position, #TestTag]", str);
                        break;

                    case 2:
                        AreEqual("id: 3  [Position, Rotation, #TestTag]", str);
                        break;

                    case 3:
                        AreEqual("id: 4  [Position, Rotation, Scale3, #TestTag]", str);
                        break;

                    case 4:
                        AreEqual("id: 5  [Position, Rotation, Scale3, MyComponent1, #TestTag]", str);
                        break;

                    case 5:
                        AreEqual("id: 6  [Position, Rotation, Scale3, MyComponent1, MyComponent2, #TestTag]", str);
                        break;
                }
            };
            var tagCount = 0;
            ...
            store.OnComponentAdded += changed => {
                ...
                switch (componentCount++)
                {
                    ...
                    case 2:
                        AreEqual("entity: 3 - event > Add Component: [Rotation]", str);
                        break;
                    ...
                    case 4:
                        AreEqual("entity: 4 - event > Add Component: [Rotation]", str);
                        break;
                    ...
                    // --- entity 5
                    case 6:
                        AreEqual("entity: 5 - event > Add Component: [Position]", str);
                        break;

                    case 7:
                        AreEqual("entity: 5 - event > Add Component: [Rotation]", str);
                        break;

                    case 8:
                        AreEqual("entity: 5 - event > Add Component: [Scale3]", str);
                        break;

                    case 9:
                        AreEqual("entity: 5 - event > Add Component: [MyComponent1]", str);
                        break;

                    // --- entity 6
                    case 10:
                        AreEqual("entity: 6 - event > Add Component: [Rotation]", str);
                        break;

                    case 11:
                        AreEqual("entity: 6 - event > Add Component: [Position]", str);
                        break;

                    case 12:
                        AreEqual("entity: 6 - event > Add Component: [Scale3]", str);
                        break;

                    case 13:
                        AreEqual("entity: 6 - event > Add Component: [MyComponent1]", str);
                        break;

                    case 14:
                        AreEqual("entity: 6 - event > Add Component: [MyComponent2]", str);
                        break;
                }
            };
            ...
            {
                var entity = store.CreateEntity(new Position(1, 1, 1), new Rotation(1, 1, 1, 1), new Scale3(1, 1, 1), new MyComponent1
                {
                    a = 1
                }, tags);
                IsTrue(entity.Tags.Has<TestTag>());
            ...
            {
                var entity = store.CreateEntity(new Rotation(1, 1, 1, 1), new Position(1, 1, 1), new Scale3(1, 1, 1), new MyComponent1
                {
                    a = 1
                }, new MyComponent2
                {
        ...
        public static void Test_Entity_CreateEntity_generic_6_and_more()
        {
            ...
            store.CreateEntity(new Position(), new Scale3(), new Rotation(), new MyComponent1(), new MyComponent2(), new MyComponent3(), new MyComponent4(),
                tag);
            store.CreateEntity(new Position(), new Scale3(), new Rotation(), new MyComponent1(), new MyComponent2(), new MyComponent3(), new MyComponent4(),
        ...
        {
            var count = 10; // 10_000_000 ~ #PC: 792 ms
            var store = new EntityStore(PidType.UsePidAsId);
            store.EnsureCapacity(count);
