...
namespace Tests.ECS
{
    public static class Test_Script
    {
            ...
            var addHandler = new Action<ScriptChanged>(args => {
                ...
                switch (addCount++)
                {
                    case 0:
                        ...
                        AreEqual("entity: 1 - event > Add Script: [*TestScript1]", str);
                        return;

                    case 1:
                        AreEqual("entity: 1 - event > Replace Script: [*TestScript2]", str);
                        return;
            ...
            var removeHandler = new Action<ScriptChanged>(args => {
                ...
                switch (removeCount++)
                {
                    case 0:
                        ...
                        // Ensure Scripts are updated                            
                        AreEqual(1, args.Entity.Scripts.Length);
                        AreEqual("entity: 1 - event > Remove Script: [*TestScript2]", str);
                        return;
        ...
        public static void Test_3_RemoveScript()
        {
            ...
            IsNull(player.AddScript(new TestScript1
            {
                val1 = 1
            }));
            IsNull(player.AddScript(new TestScript2
            {
                val2 = 2
            }));
            IsNull(player.AddScript(new TestScript3
            {
                val3 = 3
            }));
        ...
        public static void Test_3_cover_move_last_script()
        {
            ...
            IsNull(entity1.AddScript(new TestScript1
            {
                val1 = 1
            }));
            IsNull(entity2.AddScript(new TestScript2
            {
                val2 = 2
            }));
        ...
        public static void Test_3_cover_remove_non_added_script()
        {
            ...
            IsNull(entity.AddScript(new TestScript1
            {
                val1 = 1
            }));
            AreEqual(1, entity.Scripts.Length);
