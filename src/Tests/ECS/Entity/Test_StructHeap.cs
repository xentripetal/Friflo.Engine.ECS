...
namespace Tests.ECS
{
    public static class Test_StructHeap
    {
        ...
        public static void Test_StructHeap_CreateEntity_RecycleIds()
        {
            ...
            Assert.AreEqual(2, entity2b.Id);
            Assert.AreEqual(2, entity2b.Revision);
            Assert.AreEqual(1, entity1b.Id);
            Assert.AreEqual(2, entity1b.Revision);
            ...
            Assert.AreEqual(2, entity2d.Id);
            Assert.AreEqual(4, entity2d.Revision);
...
*/
        ...
        {
            var count = 10; // 100_000 (UsePidAsId) ~ #PC: 3688 ms
            // --- warmup
            var store = new EntityStore(PidType.UsePidAsId);
