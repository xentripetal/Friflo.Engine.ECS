...
namespace Tests.Utils
{
    public static class TestUtils
    {
        ...
        var baseDir = UnityUtils.GetProjectFolder();
            ...
            var baseDir = Directory.GetCurrentDirectory() + projectFolder;
#endif
            baseDir = Path.GetFullPath(baseDir + folder);
            return baseDir;
        }

        public static double StopwatchMillis(Stopwatch stopwatch) => stopwatch.ElapsedTicks * 1000.0 / Stopwatch.Frequency;
