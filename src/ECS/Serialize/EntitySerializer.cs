...
public sealed class EntitySerializer
{
    ...
    /// <summary>
    ///     Asynchronously writes all entities in the given <paramref name="store" /> as a JSON array to the passed
    ...
    private static readonly Bytes IdKey = new ("id");
    private static readonly Bytes ChildrenKey = new ("children");
    private static readonly Bytes ComponentsKey = new ("components");
    private static readonly Bytes TagsKey = new ("tags");
    ...
    /// <summary>
    ///     Asynchronously reads the JSON array of the given <paramref name="stream" /> into the passed
    ///     <paramref name="store" />.
    /// </summary>
    ...
    private static readonly Bytes Id = new ("id");
    private static readonly Bytes Children = new ("children");
    private static readonly Bytes Components = new ("components");
    private static readonly Bytes Tags = new ("tags");
