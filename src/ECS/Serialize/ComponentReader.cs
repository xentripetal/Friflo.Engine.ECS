...
/// <summary>
///     Create all components / scripts for an entity from <see cref="JsonValue" /> used as
///     <see cref="DataEntity.components" />
/// </summary>
sealed class ComponentReader
{
    ...
    internal ComponentReader()
    {
        ...
        {
            ErrorHandler = ObjectReader.NoThrow
        };
    ...
    private RawKey ToRawKey(in Bytes keyBytes)
    {
        ...
        if (rawKeyCache.TryGetValue(keyHash, out var rawKey))
        {
            return rawKey;
        }
