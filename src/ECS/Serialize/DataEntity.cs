...
/// </summary>
/// <remarks>
///     When reading / writing <see cref="DataEntity" />'s in the editor a special MemoryDatabase" implementation is
///     required.<br />
///     This implementation preserves the order of entities stored in a JSON file.<br />
///     Therefor it stores the order of each entity when loaded and apply this order when writing them back to the JSON
///     file.<br />
///     <br />
...
public sealed class DataEntity
{
    ...
    ///     <br />
    ///     An alternative order implementation - using firstChild, nextSibling - is error prone if referenced nodes are
    ///     missing.<br />
