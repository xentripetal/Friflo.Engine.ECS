...
/// <summary>
///     Create the <see cref="JsonValue" /> from all components and scripts used at <see cref="DataEntity.components" />.
///     <br />
/// </summary>
sealed class ComponentWriter
{
...
static class ComponentWriterExtensions
{
