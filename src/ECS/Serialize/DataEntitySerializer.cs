...
{
    private static readonly Bytes ComponentsStart = new ("{\n");
    private static readonly Bytes KeyStart = new ("        \"");
    private static readonly Bytes KeyEnd = new ("\": ");
    private static readonly Bytes ComponentNext = new (",\n");
    private static readonly Bytes ComponentsEnd = new ("\n    }");
    ...
    public DataEntitySerializer()
    {
        ...
        objectWriter = new ObjectWriter(new TypeStore())
        { // todo use global TypeStore
            Pretty = true,
