...
///         <see cref="ECS.Tags" />, <see cref="IComponent" />'s, <see cref="Script" />'s and other child
///         <see cref="Entity" />'s.<br />
///         <br />
///         Comparison to other game engines.
///         <list type="bullet">
///             <item>
///                 <b>Unity</b>  - an <see cref="Entity" /> provides a similar features set as a <c>GameObject</c> and
///                 their ECS <c>Entity</c>.
///             </item>
///             <item>
...
///             </item>
///             <item>
///                 <b>FLAX</b>   - <see cref="Entity" /> is the counterpart of an <c>Actor</c> - an OOP architecture like
///                 Godot.
///             </item>
///             <item>
///                 <b>STRIDE</b> - <see cref="Entity" /> is the counterpart of a STRIDE <c>Entity</c> - a component based
///                 architecture like Unity.<br />
...
///         <b>Components</b>
///         <br />
///         An <see cref="Entity" /> is typically an object that can be rendered on screen like a cube, sphere, capsule,
///         mesh, sprite, ... .<br />
///         Therefore a renderable component needs to be added with <see cref="AddComponent{T}()" /> to an
///         <see cref="Entity" />.<br />
///         <br />
///         <b>Child entities</b>
///         <br />
///         An <see cref="Entity" /> can be added to another <see cref="Entity" /> using <see cref="AddChild" />.<br />
///         The added <see cref="Entity" /> becomes a child of the <see cref="Entity" /> it is added to - its
///         <see cref="Parent" />.<br />
...
///         <b>Scripts</b>
///         <br />
///         A <see cref="Script" />'s can be added to an <see cref="Entity" /> to add custom logic (script) and data to an
///         entity.<br />
///         <see cref="Script" />'s are added or removed with <see cref="AddScript{T}" /> / <see cref="RemoveScript{T}" />.
///         <br />
///         <br />
///         <b>Tags</b>
///         <br />
///         <see cref="Tags" /> can be added to an <see cref="Entity" /> to enable filtering entities in queries.<br />
///         By adding <see cref="Tags" /> to an <see cref="ArchetypeQuery" /> it can be restricted to return only entities
///         matching the
///         these <see cref="Tags" />.<br />
///         <br />
///         <b>Events</b>
///         <br />
///         All entity changes - aka mutations - can be observed for specific <see cref="Entity" />'s and the whole
...
///                 <description>
///                     <see cref="OnComponentChanged" />
///                 </description>
///                 <description>
///                     <see cref="ComponentChanged" />
///                 </description>
///                 <description>
///                     <see cref="ComponentChangedAction.Add" />, <see cref="ComponentChangedAction.Update" />,
///                     <see cref="ComponentChangedAction.Remove" />
///                 </description>
///             </item>
///             <item>
///                 <description>script</description>
///                 <description>
///                     <see cref="OnScriptChanged" />
///                 </description>
///                 <description>
///                     <see cref="ScriptChanged" />
///                 </description>
///                 <description>
///                     <see cref="ScriptChangedAction.Remove" />, <see cref="ScriptChangedAction.Add" />,
///                     <see cref="ScriptChangedAction.Replace" />
///                 </description>
///             </item>
///             <item>
///                 <description>tags</description>
///                 <description>
///                     <see cref="OnTagsChanged" />
///                 </description>
///                 <description>
///                     <see cref="TagsChanged" />
///                 </description>
///                 <description>
...
///                 <description>
///                     <see cref="OnChildEntitiesChanged" />
///                 </description>
///                 <description>
///                     <see cref="ChildEntitiesChanged" />
///                 </description>
///                 <description>
...
public readonly partial struct Entity : IEquatable<Entity>
{
    ...
    public EntityComponents Components => new (this);

    /// <summary>Return the <see cref="Script" />'s added to the entity.</summary>
    [Browse(Never)]
    public Scripts Scripts => new (EntityUtils.GetScripts(this));
    ...
    ///     Therefore use <see cref="AddTag{T}" />, <see cref="AddTags" />, <see cref="RemoveTag{T}" /> or
    ///     <see cref="RemoveTags" />.
    /// </returns>
    public ref readonly Tags Tags
    {
        get
        {
    ...
    /// <remarks>
    ///     The <see cref="Archetype" /> the entity is stored.<br />Return null if the entity is <see cref="detached" />
    /// </remarks>
    [Browse(Never)]
    public Archetype Archetype => GetArchetype();

    /// <summary>Returns the <see cref="EntityStore" /> that contains the entity.</summary>
    /// <remarks>
    ///     The <see cref="Store" /> the entity is <see cref="attached" /> to. Returns null if <see cref="detached" />
    /// </remarks>
    [Browse(Never)]
    public EntityStore Store => GetStore();

    /// <remarks>If <see cref="attached" /> its <see cref="Store" /> and <see cref="Archetype" /> are not null. Otherwise null.</remarks>
    [Browse(Never)]
    public StoreOwnership StoreOwnership => IsNull ? detached : attached;

    /// <returns>
    ///     <see cref="treeNode" /> if the entity is member of the <see cref="EntityStore" /> tree graph.<br />
    ///     Otherwise <see cref="floating" />
    /// </returns>
    [Browse(Never)]
    public TreeMembership TreeMembership
    {
        get
        {
...
//  [Browse(Never)] public  bool IsNull          => store?.nodes[Id].archetype == null;
    ...
    {
        get => EntityUtils.EntityToJSON(this);
        internal set => EntityUtils.JsonToEntity(this, value);
    }

    /// <summary> Display additional entity information like Pid, Enabled, JSON and attached event handlers.</summary>
    internal EntityInfo Info => new (this);
    ...
    public bool Enabled
    {
        ...
        set
        {
            if (value) RemoveTags(EntityUtils.Disabled);
    ...
    /// </remarks>
    public ChildEntities ChildEntities => new (this);

    /// <summary>Return the ids of the child entities.</summary>
    [Browse(Never)]
    public ReadOnlySpan<int> ChildIds => EntityStore.GetChildIds(this);
    ...
    /// <summary>
    ///     Unique entity id.<br />
    ///     Uniqueness relates to the <see cref="Entity" />'s stored in its <see cref="EntityStore" />
    /// </summary>
    [Browse(Never)]
    [FieldOffset(8)]
    internal readonly RawEntity rawEntity; // (8)
    [FieldOffset(8)]
    public readonly int Id; //  4
    [Browse(Never)]
    [FieldOffset(12)]
    public readonly short Revision; //  2
    ...
    public bool AddComponent<T>() where T : struct, IComponent => AddComponent<T>(default);
    ...
    public TScript GetScript<TScript>() where TScript : Script, new() => (TScript)EntityUtils.GetScript(this, typeof(TScript));
    ...
    /// <summary>
    ///     Add the given <paramref name="script" /> to the entity.<br />
    ///     If the entity contains a script of the same <typeparamref name="TScript" /> <see cref="Type" /> it is replaced.
    ///     <br />
    ///     See <a href="https://friflo.gitbook.io/friflo.engine.ecs/examples/general#script">Example.</a>
    /// </summary>
    /// <returns>
    ///     The script with the passed <typeparamref name="TScript" /> <see cref="Type" /> previously added to the entity.
    ///     <br />
    ...
    public TScript AddScript<TScript>(TScript script) where TScript : Script, new() => (TScript)EntityUtils.AddScript(this, ScriptInfo<TScript>.Index, script);

    /// <summary>Remove the script with the given <typeparamref name="TScript" /> <see cref="Type" /> from the entity.</summary>
    /// <returns>
    ///     The script the script with the passed <typeparamref name="TScript" /> <see cref="Type" /> previously added to the
    ///     entity.<br />
    ...
    public TScript RemoveScript<TScript>() where TScript : Script, new() => (TScript)EntityUtils.RemoveScript(this, ScriptInfo<TScript>.Index);
    ...
    /// </summary>
    /// <remarks>
    ///     Executes in O(1) in case the entity has no children and if it is the last entity in <see cref="Parent" />.
    ///     <see cref="ChildIds" />
    /// </remarks>
    ...
    ///     <see cref="AddTag{T}" /> <br /> <see cref="AddTags" /> <br /> <see cref="RemoveTag{T}" /> <br />
    ///     <see cref="RemoveTags" />.<br />
    ...
    {
        add => EntityStoreBase.AddEntityTagsChangedHandler(store, Id, value);
    ...
    {
        add => EntityStoreBase.AddComponentChangedHandler(store, Id, value);
    ...
    {
        add => EntityStore.AddScriptChangedHandler(store, Id, value);
    ...
    {
        add => EntityStore.AddChildEntitiesChangedHandler(store, Id, value);
    ...
    ///     Practical when passing a lambda that can be removed later with <see cref="RemoveSignalHandler{TEvent}" />.
    /// </returns>
    ...
    public bool RemoveSignalHandler<TEvent>(Action<Signal<TEvent>> handler) where TEvent : struct => EntityStore.RemoveSignalHandler(store, Id, handler);
    ...
    [Browse(Never)]
    internal Archetype archetype => store.nodes[Id].archetype;
    [Browse(Never)]
    internal int compIndex => store.nodes[Id].compIndex;
