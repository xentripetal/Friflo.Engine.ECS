...
/// </summary>
/// <remarks>
///     A <see cref="Script" /> is a reference type - a class-  which contains data <b>and</b> behavior - aka scripts /
///     methods.<br />
...
///     <br />
///     <i>Info:</i> Its functionality is similar to a class extending <c>MonoBehaviour</c> added to a <c>GameObject</c> in
///     Unity.
/// </remarks>
