...
/// <summary>
///     Is the event for event handlers added to <see cref="Entity.OnChildEntitiesChanged" /> or
///     <see cref="EntityStore.OnChildEntitiesChanged" />.
/// </summary>
/// <remarks>
///     These events are fired on:
///     <list type="bullet">
///         <item>
///             <see cref="Entity.AddChild" />
///         </item>
///         <item>
///             <see cref="Entity.InsertChild" />
///         </item>
///         <item>
///             <see cref="Entity.RemoveChild" />
///         </item>
///     </list>
/// </remarks>
public readonly struct ChildEntitiesChanged
{
    ...
    public Entity Child => new (Store, ChildId);
