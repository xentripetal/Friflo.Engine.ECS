...
/// <summary>
///     The modification type of a <see cref="ComponentChanged" /> event: <see cref="Remove" />, <see cref="Add" /> or
///     <see cref="Update" /> component.
/// </summary>
public enum ComponentChangedAction
{
    ...
    Add = 1,
    /// <summary>
    ///     An <see cref="IComponent" /> of an <see cref="Entity" /> is updated when calling
    ///     <see cref="Entity.AddComponent{T}()" /> on an entity already having a component of a specific type.
    /// </summary>
    Update = 2
}
...
public readonly struct ComponentChanged
{
    ...
    /// <summary>
    ///     The executed entity change: <see cref="ComponentChangedAction.Remove" />,
    ///     <see cref="ComponentChangedAction.Add" /> or <see cref="ComponentChangedAction.Remove" /> component.
    /// </summary>
    ...
    public Entity Entity => new (Store, EntityId);
    ...
    // --- public properties
    /// <summary>
    ///     Return the current <see cref="IComponent" /> for debugging.<br />
    ///     <b>Note</b>: It degrades performance as it boxes the returned component.
    /// </summary>
    ...
    /// <summary>
    ///     Return the old <see cref="IComponent" /> for debugging.<br />
    ///     <b>Note</b>: It degrades performance as it boxes the returned component.
    /// </summary>
    ...
    ///     In case the <see cref="Action" /> was
    ///     <see cref="ComponentChangedAction.Remove" /> component.
    /// </exception>
    ...
    ///     Instead store the value returned by <see cref="OldComponent{T}" /> within the handler when using it after the event
    ///     handler returns.<br />
    ...
    /// <exception cref="InvalidOperationException">
    ///     In case the <see cref="Action" /> was
    ///     <see cref="ComponentChangedAction.Add" /> component.
    /// </exception>
    /// <exception cref="ArgumentException"> In case the component is accessed with the wrong generic type. </exception>
    ...
    private static InvalidOperationException ActionException(string message, Type type) => new (message + type.Name);

    private ArgumentException TypeException(string message, Type type) => new ($"{message}{ComponentType.Name}. T: {type.Name}");
