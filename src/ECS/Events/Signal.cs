...
/// <summary>
///     <see cref="Signal{TEvent}" />'s are used to emit custom events from an entity to custom
///     <see cref="Signal{TEvent}" /> handlers.<br />
...
public readonly struct Signal<TEvent> where TEvent : struct
{
    ...
    /// <summary>
    ///     The id of the <see cref="Entity" /> that emitted the <see cref="Event" /> with
    ///     <see cref="ECS.Entity.EmitSignal{TEvent}" />.
    /// </summary>
    public readonly int EntityId;
    /// <summary>
    ///     The <see cref="Event" /> containing event specific data passed to <see cref="ECS.Entity.EmitSignal{TEvent}" />
    ///     .
    /// </summary>
    ...
    // --- properties
    /// <summary>
    ///     The <see cref="Entity" /> that emitted the <see cref="Event" /> with
    ///     <see cref="ECS.Entity.EmitSignal{TEvent}" /> - aka the publisher.
    /// </summary>
