...
/// <summary>
///     The modification type of a <see cref="ScriptChanged" /> event: <see cref="Remove" />, <see cref="Add" /> or
///     <see cref="Replace" /> script.
/// </summary>
...
///     <list type="bullet">
///         <item>
///             <see cref="Entity.AddScript{TScript}" />
///         </item>
///         <item>
...
public readonly struct ScriptChanged
{
    ...
    /// <summary>
    ///     The executed entity change: <see cref="ScriptChangedAction.Remove" />,
    ///     <see cref="ScriptChangedAction.Add" /> or <see cref="ScriptChangedAction.Replace" /> script.
    /// </summary>
    public readonly ScriptChangedAction Action; //  4

    /// <summary>
    ///     The new <see cref="ECS.Script" /> after executing <see cref="ScriptChangedAction.Add" /> or
    ///     <see cref="ScriptChangedAction.Replace" />.<br />
    ...
    /// <summary>
    ///     The <see cref="ECS.Script" /> before executing <see cref="ScriptChangedAction.Remove" /> or
    ///     <see cref="ScriptChangedAction.Replace" />.<br />
