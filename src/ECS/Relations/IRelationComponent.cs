...
///     The components added to a single entity build a set of components using the relation <typeparamref name="TKey" />
...
///     <list type="bullet">
///         <item>
///             Add multiple relation components to an entity using
///             <see cref="RelationExtensions.AddRelation{TComponent}" />.
///         </item>
///         <item>
///             Return all relation components of an entity using
///             <see cref="RelationExtensions.GetRelations{TComponent}" />.
///         </item>
///         <item>
///             Return a specific relation by key using  <see cref="RelationExtensions.GetRelation{TComponent,TKey}" />
///             <br />
