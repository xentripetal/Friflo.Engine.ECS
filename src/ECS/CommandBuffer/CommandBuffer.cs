...
///     <see cref="CommandBuffer" /> is not thread safe. To record changes on arbitrary threads use <see cref="Synced" />.
///     <br />
...
public sealed class CommandBuffer : ICommandBuffer
{
    ...
    [Browse(Never)]
    public int ComponentCommandsCount => GetComponentCommandsCount(intern.componentCommandTypes);

    /// <summary> Return the number of recorded tag commands. </summary>
    [Browse(Never)]
    public int TagCommandsCount => intern.tagCommandsCount;

    /// <summary> Return the number of recorded script commands. </summary>
    [Browse(Never)]
    public int ScriptCommandsCount => intern.scriptCommandsCount;

    /// <summary> Return the number of recorded add / remove child commands. </summary>
    [Browse(Never)]
    public int ChildCommandsCount => intern.childCommandsCount;

    /// <summary> Return the number of recorded entity commands. </summary>
    [Browse(Never)]
    public int EntityCommandsCount => intern.entityCommandCount;

    [Browse(Never)]
    public EntityStore EntityStore => intern.store;

    /// <summary>
    ///     Set <see cref="ReuseBuffer" /> = true to reuse a <see cref="CommandBuffer" /> instance for multiple
    ///     <see cref="Playback" />'s.
    /// </summary>
    public bool ReuseBuffer
    {
        get => intern.reuseBuffer;
        set => intern.reuseBuffer = value;
    }
    ...
    private void ExecuteTagCommands(Playback playback)
    {
        ...
        foreach (var tagCommand in commands)
        {
            ...
            ref var changeIndex = ref CollectionsMarshal.GetValueRefOrAddDefault(indexes, entityId, out exists);
#else
    ...
    private static InvalidOperationException EntityNotFound(TagCommand command) => new ($"Playback - entity not found. command: {command}");
    ...
    /// <summary>
    ///     Add the <see cref="IComponent" /> with type <typeparamref name="T" /> to the entity with the passed
    ...
    /// <summary>
    ///     Add the given <paramref name="component" /> with type <typeparamref name="T" /> to the entity with the passed
    ///     <paramref name="entityId" />.
    /// </summary>
    ...
    /// <summary>
    ///     Set the given <paramref name="component" /> with type <typeparamref name="T" /> of the entity with the passed
    ///     <paramref name="entityId" />.
    /// </summary>
    ...
    /// <summary>
    ///     Remove the <see cref="IComponent" /> with type <typeparamref name="T" /> from the entity with the passed
    ///     <paramref name="entityId" />.
    /// </summary>
    ...
    /// <summary>
    ///     Add the <see cref="ITag" /> with type <typeparamref name="T" /> to the entity with the passed
    ///     <paramref name="entityId" />.
    /// </summary>
    ...
    /// <summary>
    ///     Remove the <see cref="ITag" /> with type <typeparamref name="T" /> from the entity with the passed
    ///     <paramref name="entityId" />.
    /// </summary>
    ...
    /// <summary>
    ///     Remove the <see cref="Script" /> of the specified type <typeparamref name="T" /> from the entity with the passed
    ///     <paramref name="entityId" />.
    /// </summary>
    ...
    /// <summary>
    ///     Add the entity with the given <paramref name="childId" /> as a child to the entity with the passed
    ...
    /// <summary>
    ///     Remove the child entity with given <paramref name="childId" /> from the parent entity with the the passed
    ///     <paramref name="parentId" />.
    /// </summary>
