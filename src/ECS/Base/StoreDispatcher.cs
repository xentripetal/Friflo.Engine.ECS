...
/// <summary>
///     Contains methods to dispatch execution of <see cref="Action" />'s or <see cref="Func{TResult}" />'s to the main
///     thread.
/// </summary>
/// <remarks>
///     These methods are required to access an <see cref="ECS.EntityStore" /> as instances of this class are not thread
///     safe.
...
{
    private static readonly DefaultDispatcher DefaultDispatcher = new ();
...
sealed class DefaultDispatcher : IStoreDispatcher
{
    public void AssertMainThread() { }
