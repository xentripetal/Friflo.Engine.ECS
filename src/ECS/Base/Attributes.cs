...
/// <summary>
///     Assign a custom key used for JSON serialization for annotated <see cref="IComponent" /> and <see cref="Script" />
///     types.<br />
...
///     Prefer using single character names for common used symbols. Consider
///     <a href="https://en.wikipedia.org/wiki/List_of_Unicode_characters">Unicode characters</a>.
/// </summary>
/// <remarks>
