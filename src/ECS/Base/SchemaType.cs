...
public abstract class SchemaType
{
    ...
    /// <summary>
    ///     If <see cref="Kind" /> == <see cref="Tag" /> the type of a <b>tag</b> struct implementing <see cref="ITag" />.
    ///     <br />
    ///     If <see cref="Kind" /> == <see cref="Component" /> the type of a <b>component</b> struct implementing
    ///     <see cref="IComponent" />.<br />
    ///     If <see cref="Kind" /> == <see cref="Script" /> the type of a <b>script</b> class extending <see cref="Script" />.
    ///     <br />
    /// </summary>
    ...
    private static readonly Dictionary<Type, BlittableType> BlittableTypes = new ();
    ...
    internal static BlittableType GetBlittableType(Type type)
    {
        ...
        if (BlittableTypes.TryGetValue(type, out var blittable))
        {
            return blittable;
        }
        if (type.IsArray)
