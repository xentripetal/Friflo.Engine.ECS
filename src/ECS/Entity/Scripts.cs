...
public readonly struct Scripts : IEnumerable<Script>
{
    ...
    internal Scripts(Script[] array) => this.array = array;

    public Script this[int index] => array[index];

    public ScriptsEnumerator GetEnumerator() => new (array);
...
sealed class ScriptsDebugView
{
    private readonly Scripts scripts;

    internal ScriptsDebugView(Scripts scripts) => this.scripts = scripts;
