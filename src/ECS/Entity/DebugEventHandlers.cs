...
/// <summary>
///     Provide the event / signal handlers of an entity using <see cref="Entity" />.
///     <see cref="Entity.DebugEventHandlers" />.
/// </summary>
public readonly struct DebugEventHandlers
{
    [Browse(Never)]
    public int TypeCount => Array.Length;
    [Browse(Never)]
...
/// <summary>
///     Used as item type in <see cref="DebugEventHandlers" /> providing the number of handlers for a specific event
///     <see cref="Type" />.
/// </summary>
