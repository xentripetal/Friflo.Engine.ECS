...
/// <summary>
///     Provide generic <c>CreateEntity()</c> overloads to create entities with passed components without any structural
///     change.
/// </summary>
public static partial class EntityStoreExtensions
{
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1>.ComponentTypes, tags, out var archetype, out var compIndex);
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1, T2>.ComponentTypes, tags, out var archetype, out var compIndex);
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1, T2, T3>.ComponentTypes, tags, out var archetype, out var compIndex);
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1, T2, T3, T4>.ComponentTypes, tags, out var archetype, out var compIndex);
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1, T2, T3, T4, T5>.ComponentTypes, tags, out var archetype, out var compIndex);
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1, T2, T3, T4, T5, T6>.ComponentTypes, tags, out var archetype, out var compIndex);
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1, T2, T3, T4, T5, T6, T7>.ComponentTypes, tags, out var archetype, out var compIndex);
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1, T2, T3, T4, T5, T6, T7, T8>.ComponentTypes, tags, out var archetype, out var compIndex);
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1, T2, T3, T4, T5, T6, T7, T8, T9>.ComponentTypes, tags, out var archetype, out var compIndex);
    ...
    {
        var entity = CreateEntityGeneric(store, Generic<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>.ComponentTypes, tags, out var archetype, out var compIndex);
        AssignComponents(archetype, compIndex, component1, component2, component3, component4, component5, component6, component7, component8, component9,
            component10);
