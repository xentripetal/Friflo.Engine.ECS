...
partial struct StoreExtension
{
    ...
    [Browse(Never)]
    internal int entityScriptCount; //  4   - invariant: > 0  and  <= entityScripts.Length
    /// <summary>
    ///     Contains implicit all entities with one or more <see cref="Script" />'s to minimize iteration cost for
    ///     <see cref="Script.Update" />.
    /// </summary>
