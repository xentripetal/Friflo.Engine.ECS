...
public partial class EntityStore
{
    ...
    public Entity CloneEntity(Entity entity)
    {
        ...
        else
        {
            ...
            converter.DataEntityToEntity(dataBuffer, this, out var error); // error == null. No possibility for mapping errors
            AssertNoError(error);
        }
        // Send event. See: SEND_EVENT notes
    ...
    [Conditional("DEBUG")]
    [ExcludeFromCodeCoverage] // assert invariant
    ...
    internal void CreateEntityNodes(Archetype archetype, int count)
    {
        ...
        var compIndexStart = archetype.entityCount;
        ...
        for (var index = compIndexStart; index < maxIndex; index++)
        {
