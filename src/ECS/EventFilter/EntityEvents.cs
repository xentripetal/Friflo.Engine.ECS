...
public struct EntityEvent
{
    ...
    /// <summary>
    ///     The index in <see cref="EntitySchema" /> properties <see cref="EntitySchema.Components" /> or
    ///     <see cref="EntitySchema.Tags" />.
    /// </summary>
...
sealed class EntityEvents
{
    ...
    private string GetString() => $"events: {eventCount}";
