    ...
    where T2 : struct, IComponent
{
    ...
    /// <summary>
    ///     Return the <see cref="Chunk{T}" />'s storing the components and entities of an <see cref="ArchetypeQuery{T1,T2}" />
    ///     .<br />
    ...
    public new ArchetypeQuery<T1, T2> AllTags(in Tags tags)
    {
        SetHasAllTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2> AnyTags(in Tags tags)
    {
        SetHasAnyTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2> WithDisabled()
    {
        SetWithDisabled();
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2> WithoutAllTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1, T2> WithoutAnyTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1, T2> AllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2> AnyComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2> WithoutAllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2> WithoutAnyComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2> ValueInRange<TComponent, TValue>(TValue min, TValue max)
    ...
    public new ArchetypeQuery<T1, T2> FreezeFilter()
    {
        SetFreezeFilter();
        return this;
    }
    ...
    {
        var store = Store;
        foreach ((var chunk1, var chunk2, var entities) in Chunks)
        {
