    ...
    where T2 : struct, IComponent
{
    ...
    internal QueryChunks(ArchetypeQuery<T1, T2> query) => this.query = query;
    ...
    where T2 : struct, IComponent
{
    ...
    public Chunks<T1, T2> Current { get; private set; }
    ...
    public bool MoveNext()
    {
        ...
        Current = new Chunks<T1, T2>(chunk1, chunk2, entities);
        return true;
        SingleEntity:
        if (pos >= types.last)
        {
