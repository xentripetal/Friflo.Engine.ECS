    ...
    where T3 : struct, IComponent
{
    ...
    ///     <see cref="ArchetypeQuery{T1,T2,T3}" />.<br />
    ...
    public new ArchetypeQuery<T1, T2, T3> AllTags(in Tags tags)
    {
        SetHasAllTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2, T3> AnyTags(in Tags tags)
    {
        SetHasAnyTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2, T3> WithDisabled()
    {
        SetWithDisabled();
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2, T3> WithoutAllTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3> WithoutAnyTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3> AllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3> AnyComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3> WithoutAllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3> WithoutAnyComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3> ValueInRange<TComponent, TValue>(TValue min, TValue max)
    ...
    public new ArchetypeQuery<T1, T2, T3> FreezeFilter()
    {
        SetFreezeFilter();
        return this;
    }
    ...
    {
        var store = Store;
        foreach ((var chunk1, var chunk2, var chunk3, var entities) in Chunks)
        {
