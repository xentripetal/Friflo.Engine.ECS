    ...
    where T1 : struct, IComponent
{
    ...
    /// <summary>
    ///     Return the <see cref="Chunk{T}" />'s storing the components and entities of an <see cref="ArchetypeQuery{T1}" />.
    ///     <br />
    ...
    public new ArchetypeQuery<T1> AllTags(in Tags tags)
    {
        SetHasAllTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1> AnyTags(in Tags tags)
    {
        SetHasAnyTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1> WithDisabled()
    {
        SetWithDisabled();
        return this;
    }
    ...
    public new ArchetypeQuery<T1> WithoutAllTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1> WithoutAnyTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1> AllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1> AnyComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1> WithoutAllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1> WithoutAnyComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1> ValueInRange<TComponent, TValue>(TValue min, TValue max)
    ...
    public new ArchetypeQuery<T1> FreezeFilter()
    {
        SetFreezeFilter();
        return this;
    }
    ...
    {
        var store = Store;
        foreach ((var chunk1, var entities) in Chunks)
        {
