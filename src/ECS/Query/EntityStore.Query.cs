...
public partial class EntityStoreBase
{
    ...
    /// </summary>
    public ArchetypeQuery Query() => new (this, new ComponentTypes(), null);
    ...
    /// </summary>
    public ArchetypeQuery Query(QueryFilter filter) => new (this, new ComponentTypes(), filter);
    ...
    public ArchetypeQuery<T1> Query<T1>()
        where T1 : struct, IComponent
        => new (this, Signature.Get<T1>(), null);
    ...
    public ArchetypeQuery<T1> Query<T1>(QueryFilter filter)
        where T1 : struct, IComponent
        => new (this, Signature.Get<T1>(), filter);
