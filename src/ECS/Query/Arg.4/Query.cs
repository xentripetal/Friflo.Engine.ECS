    ...
    where T4 : struct, IComponent
{
    ...
    ///     <see cref="ArchetypeQuery{T1,T2,T3,T4}" />.<br />
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> AllTags(in Tags tags)
    {
        SetHasAllTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> AnyTags(in Tags tags)
    {
        SetHasAnyTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> WithDisabled()
    {
        SetWithDisabled();
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> WithoutAllTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> WithoutAnyTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> AllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> AnyComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> WithoutAllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> WithoutAnyComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> ValueInRange<TComponent, TValue>(TValue min, TValue max)
    ...
    public new ArchetypeQuery<T1, T2, T3, T4> FreezeFilter()
    {
        SetFreezeFilter();
        return this;
    }
    ...
    {
        var store = Store;
        foreach ((var chunk1, var chunk2, var chunk3, var chunk4, var entities) in Chunks)
        {
