...
/// <summary>
///     Provide the state of an <paramref name="entity" /> within
///     <see cref="ArchetypeQuery{T1,T2,T3,T4,T5}.ForEachEntity" />.
/// </summary>
public delegate void ForEachEntity<T1, T2, T3, T4, T5>(
    ref T1 component1,
    ref T2 component2,
    ref T3 component3,
    ref T4 component4,
    ...
    where T5 : struct, IComponent
{
    ...
    /// <summary>
    ///     Return the <see cref="Chunk{T}" />'s storing the components and entities of an
    ///     <see cref="ArchetypeQuery{T1,T2,T3,T4,T5}" />.<br />
    ...
    public new ArchetypeQuery<T1, T2, T3, T4, T5> AllTags(in Tags tags)
    {
        SetHasAllTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2, T3, T4, T5> AnyTags(in Tags tags)
    {
        SetHasAnyTags(tags);
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2, T3, T4, T5> WithDisabled()
    {
        SetWithDisabled();
        return this;
    }
    ...
    public new ArchetypeQuery<T1, T2, T3, T4, T5> WithoutAllTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4, T5> WithoutAnyTags(in Tags tags)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4, T5> AllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4, T5> AnyComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4, T5> WithoutAllComponents(in ComponentTypes componentTypes)
    {
    ...
    public new ArchetypeQuery<T1, T2, T3, T4, T5> WithoutAnyComponents(in ComponentTypes componentTypes)
    {
    ...
    {
        base.HasValue<TComponent, TValue>(value);
        return this;
    }

    /// <inheritdoc cref="QueryFilter.ValueInRange{TComponent,TValue}" />
    public new ArchetypeQuery<T1, T2, T3, T4, T5> ValueInRange<TComponent, TValue>(TValue min, TValue max) where TComponent : struct, IIndexedComponent<TValue>
        where TValue : IComparable<TValue>
    {
        base.ValueInRange<TComponent, TValue>(min, max);
        return this;
    }

    /// <inheritdoc cref="ArchetypeQuery.FreezeFilter" />
    public new ArchetypeQuery<T1, T2, T3, T4, T5> FreezeFilter()
    {
        SetFreezeFilter();
        return this;
    }
    ...
    {
        var store = Store;
        foreach ((var chunk1, var chunk2, var chunk3, var chunk4, var chunk5, var entities) in Chunks)
        {
