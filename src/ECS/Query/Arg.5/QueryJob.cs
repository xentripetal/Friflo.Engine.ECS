    ...
    where T5 : struct, IComponent
{
    ...
    private static int GetMultiple()
    {
        ...
        var lcm4 = ComponentType<T4>.ComponentMultiple;
        var lcm5 = ComponentType<T5>.ComponentMultiple;
        var lcm12 = LeastComponentMultiple(lcm1, lcm2);
        var lcm34 = LeastComponentMultiple(lcm3, lcm4);
        var lcm1234 = LeastComponentMultiple(lcm12, lcm34);
