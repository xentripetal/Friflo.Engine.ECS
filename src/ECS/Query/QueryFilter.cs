...
public class QueryFilter
{
    ...
    public readonly struct FilterCondition
    {
         ...
         */
        public Tags AllTags => filter.allTags;
        /**
         * Entity must have any tag.
         */
        public Tags AnyTags => filter.anyTags;
        /**
         * Entity must not have all tags.
         */
        public Tags WithoutAllTags => filter.withoutAllTags;
        /**
         * Entity must not have any tag.
         */
        public Tags WithoutAnyTags => filter.withoutAnyTags;

        /**
         * Entity must have all component types.
         */
        public ComponentTypes AllComponents => filter.allComponents;
        /**
         * Entity must have any component types.
         */
        public ComponentTypes AnyComponents => filter.anyComponents;
        /**
         * Entity must not have all component types.
         */
        public ComponentTypes WithoutAllComponents => filter.withoutAllComponents;
        /**
         * Entity must not have any component types.
         */
        public ComponentTypes WithoutAnyComponents => filter.withoutAnyComponents;

        [Browse(Never)]
        private readonly QueryFilter filter;

        internal FilterCondition(QueryFilter filter) => this.filter = filter;
    }
    ...
    [Browse(Never)]
    private int withoutAllTagsCount; //   8
    [Browse(Never)]
    private int anyTagsCount; //   8
    [Browse(Never)]
    private int allTagsCount; //   8

    [Browse(Never)]
    private int withoutAllComponentsCount; //   8
    [Browse(Never)]
    private int anyComponentsCount; //   8
    [Browse(Never)]
    private int allComponentsCount; //   8
    ...
    /// </summary>
    public QueryFilter ValueInRange<TComponent, TValue>(TValue min, TValue max)
