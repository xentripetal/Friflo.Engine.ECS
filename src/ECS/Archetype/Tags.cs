...
/// <summary>
///     <see cref="Tags" /> define a set of <see cref="ITag" />'s used to query entities in an
///     <see cref="EntityStoreBase" />.
/// </summary>
[CLSCompliant(true)]
...
public struct Tags : IEnumerable<TagType>, IEquatable<Tags>
{
    ...
    public readonly TagsEnumerator GetEnumerator() => new (this);
    ...
    public Tags(in BitSet value) => bitSet = value;
    ...
    /// </summary>
    public readonly bool HasAll(in Tags tags) => bitSet.HasAll(tags.bitSet);

    /// <summary>
    ///     Return true if it contains any of the passed <paramref name="tags" />.
    /// </summary>
    public readonly bool HasAny(in Tags tags) => bitSet.HasAny(tags.bitSet);
...
public struct TagsEnumerator : IEnumerator<TagType>
{
    ...
    internal TagsEnumerator(in Tags tags) => bitSetEnumerator = new BitSetEnumerator(tags.bitSet);
...
class TagsDebugView
{
    ...
    internal TagsDebugView(Tags tags) => this.tags = tags;
