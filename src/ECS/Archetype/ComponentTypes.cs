...
public struct ComponentTypes : IEnumerable<ComponentType>
{
    ...
    public readonly ComponentTypesEnumerator GetEnumerator() => new (this);
    ...
    internal ComponentTypes(in SignatureIndexes indexes)
    {
        ...
        Type5:
        bitSet.SetBit(indexes.T5);
        Type4:
        bitSet.SetBit(indexes.T4);
        Type3:
        bitSet.SetBit(indexes.T3);
        Type2:
        bitSet.SetBit(indexes.T2);
        Type1:
        bitSet.SetBit(indexes.T1);
    }
    ...
    public readonly bool Has<T1>()
        ...
        => bitSet.Has(StructInfo<T1>.Index);
    ...
    /// </summary>
    public readonly bool HasAll(in ComponentTypes componentTypes) => bitSet.HasAll(componentTypes.bitSet);

    /// <summary>
    ///     Return true if it contains any of the passed <paramref name="componentTypes" />.
    /// </summary>
    public readonly bool HasAny(in ComponentTypes componentTypes) => bitSet.HasAny(componentTypes.bitSet);
    ...
    public static ComponentTypes Get<T1, T2, T3>()
        ...
        where T2 : struct, IComponent
        where T3 : struct, IComponent
        => Generic<T1, T2, T3>.ComponentTypes;
    ...
    public static ComponentTypes Get<T1, T2, T3, T4>()
        ...
        => Generic<T1, T2, T3, T4>.ComponentTypes;
    ...
    public static ComponentTypes Get<T1, T2, T3, T4, T5>()
        ...
        => Generic<T1, T2, T3, T4, T5>.ComponentTypes;
...
public struct ComponentTypesEnumerator : IEnumerator<ComponentType>
{
    ...
    internal ComponentTypesEnumerator(in ComponentTypes componentTypes) => bitSetEnumerator = new BitSetEnumerator(componentTypes.bitSet);
...
class ComponentTypesDebugView
{
    [Browse(Never)]
    private readonly ComponentTypes componentTypes;

    internal ComponentTypesDebugView(ComponentTypes componentTypes) => this.componentTypes = componentTypes;
