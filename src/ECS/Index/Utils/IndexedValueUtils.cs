...
static class IndexedValueUtils
{
    ...
    private static TValue GetIndexedComponentValue<TComponent, TValue>(in TComponent component)
        ...
        => component.GetIndexedValue();
}

static class IndexedValueUtils<TComponent, TValue>
    where TComponent : struct, IComponent
{
    ...
    static IndexedValueUtils() => GetIndexedValue = IndexedValueUtils.CreateGetValue<TComponent, TValue>();
}

delegate TValue GetIndexedValue<TComponent, out TValue>(in TComponent component)
    where TComponent : struct, IComponent;
