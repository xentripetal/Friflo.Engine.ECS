...
public static class IndexExtensions
{
    ...
    /// <summary>
    ///     Return the entities with a link component referencing the <paramref name="target" /> entity of the passed
    ///     <see cref="ILinkComponent" /> type.<br />
    ///     Executes in O(1).
    /// </summary>
    ...
    ///         </item>
    ///         <item>
    ///             To get the entities having a specific component value use
    ///             <see cref="GetEntitiesWithComponentValue{TComponent,TValue}" />.
    ///         </item>
    ///         <item>
