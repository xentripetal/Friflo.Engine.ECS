...
/// <summary>
///     A <see cref="TreeNode" /> component stores the <see cref="Entity.ChildEntities" /> of an <see cref="Entity" />.
///     <br />
...
///     If these array buffers grown large enough over time no heap allocations will happen if adding or removing child
///     entities.<br />
/// </remarks>
[ComponentKey(null)]
public struct TreeNode : IComponent
{
    ...
    ///     Executes in O(1).
    /// </summary>
    public ChildEntities GetChildEntities(EntityStore store) => new (store, this);
