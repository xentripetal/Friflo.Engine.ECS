...
/// <summary>
///     A <see cref="SystemRoot" /> setup a system hierarchy required to execute systems with
///     <see cref="SystemGroup.Update" />.
/// </summary>
...
public class SystemRoot : SystemGroup
{
    ...
    [Browse(Never)]
    private readonly Dictionary<int, BaseSystem> systemMap = new ();
    [Browse(Never)]
    private int nextId;
    [Browse(Never)]
    internal ReadOnlyList<EntityStore> stores;
    [Browse(Never)]
    internal ReadOnlyList<BaseSystem> systemBuffer;
