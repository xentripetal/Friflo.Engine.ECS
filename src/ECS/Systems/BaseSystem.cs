...
public abstract class BaseSystem
{
    ...
    [Browse(Never)]
    [Ignore]
    public ref readonly UpdateTick Tick => ref tick;
    ...
    [Browse(Never)]
    public ref readonly SystemPerf Perf => ref perf;
    ...
    [Browse(Never)]
    private SystemGroup parentGroup;
    [Browse(Never)]
    private SystemRoot systemRoot;
    [Browse(Never)]
    [Ignore]
    internal SystemPerf perf;
    [Browse(Never)]
    private View view;
    [Browse(Never)]
    ...
    /// </summary>
    internal protected virtual void OnUpdateGroup() { }

    /// <summary>
    ///     Called for every system of the parent <see cref="SystemGroup.ChildSystems" /> before group
    ///     <see cref="SystemGroup.OnUpdateGroup" />.
    /// </summary>
    internal protected virtual void OnUpdateGroupBegin() { }

    /// <summary>
    ///     Called for every system of the parent <see cref="SystemGroup.ChildSystems" /> after group
    ///     <see cref="SystemGroup.OnUpdateGroup" />.
    /// </summary>
    internal protected virtual void OnUpdateGroupEnd() { }
    ...
    /// <summary>
    ///     Add performance statistics formatted as a table to the given <see cref="StringBuilder" /> without memory
    ///     allocations.
    /// </summary>
