...
public class SystemGroup : BaseSystem, IEnumerable
{
    ...
    [Browse(Never)]
    public bool MonitorPerf => monitorPerf;
    ...
    private string name;
    [Browse(Never)]
    internal ReadOnlyList<BaseSystem> childSystems;
    [Browse(Never)]
    internal ReadOnlyList<CommandBuffer> commandBuffers;
    [Browse(Never)]
    [Ignore]
    private bool monitorPerf;
    ...
    /// </summary>
    public ReadOnlyListEnumerator<BaseSystem> GetEnumerator() => new (childSystems);
