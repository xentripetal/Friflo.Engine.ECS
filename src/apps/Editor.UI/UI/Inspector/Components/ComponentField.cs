...
{
    private static readonly TypeStore TypeStore = new (); // todo  use shared TypeStore
    ...
    )
    {
            ...
            type == typeof(Scale3))
        {
            ...
            field.control = new Vector3Field
            {
        ...
        if (type == typeof(Transform))
        {
            ...
            field0.control = new Vector3Field
            {
                ComponentField = field0
            };
            field1.control = new Vector3Field
            {
                ComponentField = field1
            };
            fields.Add(field0);
            fields.Add(field1);
            return true;
        ...
        if (type == typeof(Unresolved))
        {
            ...
            field.control = new UnresolvedField
            {
                ComponentField = field
            };
            fields.Add(field);
    ...
    internal static void AddScriptFields(List<ComponentField> fields, ComponentType componentType, Type type)
    {
        ...
        for (var n = 0; n < propFields.Length; n++)
        {
