...
//  public  event       PropertyChangedEventHandler         PropertyChanged;
    ...
    public ObservableList() => collection = new List<T>();
    ...
    bool IList.Contains(object value) => collection.Contains((T)value);

    int IList.IndexOf(object value) => collection.IndexOf((T)value);
    ...
    bool ICollection<T>.Contains(T item) => collection.Contains(item);
    ...
    int IList<T>.IndexOf(T item) => collection.IndexOf(item);
