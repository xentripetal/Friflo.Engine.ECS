...
/// <summary>
///     Extended <see cref="TreeDataGrid" /> should not be necessary. But is needed to get <see cref="OnKeyDown" />
///     callbacks.<br />
///     <br />
...
public class ExplorerTreeDataGrid : TreeDataGrid
{
    ...
    private void OnSelectionChanged(TreeSelectionModelSelectionChangedEventArgs _)
    {
        ...
        appEvents.SelectionChanged(new EditorSelection
        {
            item = selectedItem
        });
    }
    ...
    private ExplorerItem GetRootItem() => GridSource.Items.First();
    ...
    internal IndexPath GetSelectionPath() => RowSelection!.SelectedIndexes[0];
    ...
    private bool HandleGetFocus(GotFocusEventArgs e)
    {
        ...
        {
            var passFocus = e.Source is TreeDataGrid; // || e.Source is TreeDataGridColumnHeader;
